...
class FormState:
    ...
    Attributes:
        fields: List of all form fields to collect
    ...
    def current_field(self) -> Optional[FormField]:
        ...
        Returns:
            The FormField at current_index, or None if we've passed the end
        """
    ...
    def advance(self) -> Optional[FormField]:
        ...
        Returns:
            The next FormField, or None if form is complete
        """
    ...
    def to_pdf_format(self) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary ready for PDF filling, keyed by PDF field IDs

        Raises:
            ImportError: If pdf_generator module cannot be imported
        """
        from .pdf_generator import transform_answers_to_pdf_format
