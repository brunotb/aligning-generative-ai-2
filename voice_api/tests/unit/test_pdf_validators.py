"""Unit tests for pdf_validators module."""

import pytest

from voice_api import pdf_validators
...
class TestValidateText:
    ...
    def test_valid_text(self):
        ...
        is_valid, msg = pdf_validators._validate_text("Mueller")
        assert is_valid is True
        assert msg == ""

    def test_text_with_spaces(self):
        """Text with spaces should validate."""
        is_valid, msg = pdf_validators._validate_text("von Gräfenberg")
        assert is_valid is True

    def test_empty_text(self):
        """Empty text should fail."""
        is_valid, msg = pdf_validators._validate_text("")
...
class TestValidateDateDe:
    ...
    def test_valid_full_year(self):
        ...
        is_valid, msg = pdf_validators._validate_date_de("15.01.1990")
        assert is_valid is True

    def test_valid_two_digit_year_20xx(self):
        """Two-digit year <= 30 should become 20xx."""
        is_valid, msg = pdf_validators._validate_date_de("15.01.25")
        assert is_valid is True

    def test_valid_two_digit_year_19xx(self):
        """Two-digit year > 30 should become 19xx."""
        is_valid, msg = pdf_validators._validate_date_de("15.01.85")
        assert is_valid is True

    def test_invalid_format_no_dots(self):
        """Date without dots should fail."""
        is_valid, msg = pdf_validators._validate_date_de("15011990")
        assert is_valid is False

    def test_invalid_day(self):
        """Invalid day (32) should fail."""
        is_valid, msg = pdf_validators._validate_date_de("32.01.1990")
        assert is_valid is False

    def test_invalid_month(self):
        """Invalid month (13) should fail."""
        is_valid, msg = pdf_validators._validate_date_de("15.13.1990")
        assert is_valid is False

    def test_empty_date(self):
        """Empty date should fail."""
        is_valid, msg = pdf_validators._validate_date_de("")
        assert is_valid is False
...
class TestValidateIntegerChoice:
    ...
    def test_valid_within_range(self):
        ...
        is_valid, msg = pdf_validators._validate_integer_choice("1", 0, 3)
        assert is_valid is True

    def test_valid_at_min(self):
        """Integer at minimum should pass."""
        is_valid, msg = pdf_validators._validate_integer_choice("0", 0, 3)
        assert is_valid is True

    def test_valid_at_max(self):
        """Integer at maximum should pass."""
        is_valid, msg = pdf_validators._validate_integer_choice("3", 0, 3)
        assert is_valid is True
    ...
    def test_above_max(self):
        ...
        is_valid, msg = pdf_validators._validate_integer_choice("5", 0, 3)
        assert is_valid is False
        assert "too large" in msg.lower()

    def test_non_integer(self):
        """Non-integer should fail."""
        is_valid, msg = pdf_validators._validate_integer_choice("abc", 0, 3)
        assert is_valid is False
        assert "whole number" in msg.lower()

    def test_empty_value(self):
        """Empty value should fail."""
        is_valid, msg = pdf_validators._validate_integer_choice("", 0, 3)
        assert is_valid is False

    def test_no_max_constraint(self):
        """Large integer with no max should pass."""
        is_valid, msg = pdf_validators._validate_integer_choice("999", 0, None)
        assert is_valid is True
...
class TestValidatePostalCodeDe:
    ...
    def test_valid_five_digit_code(self):
        ...
        is_valid, msg = pdf_validators._validate_postal_code_de("80802")
        assert is_valid is True

    def test_valid_four_digit_code(self):
        """Valid 4-digit postal code should pass."""
        is_valid, msg = pdf_validators._validate_postal_code_de("1015")
        assert is_valid is True

    def test_invalid_three_digit_code(self):
        """3-digit postal code should fail."""
        is_valid, msg = pdf_validators._validate_postal_code_de("808")
        assert is_valid is False

    def test_invalid_six_digit_code(self):
        """6-digit postal code should fail."""
        is_valid, msg = pdf_validators._validate_postal_code_de("808020")
        assert is_valid is False

    def test_non_numeric(self):
        """Non-numeric postal code should fail."""
        is_valid, msg = pdf_validators._validate_postal_code_de("8080a")
        assert is_valid is False

    def test_empty_code(self):
        """Empty postal code should fail."""
        is_valid, msg = pdf_validators._validate_postal_code_de("")
        assert is_valid is False
...
class TestValidateByType:
    ...
    def test_dispatch_text(self):
        ...
        is_valid, msg = pdf_validators.validate_by_type("text", "Mueller")
        assert is_valid is True

    def test_dispatch_date_de(self):
        """Dispatch to German date validator."""
        is_valid, msg = pdf_validators.validate_by_type("date_de", "15.01.1990")
        assert is_valid is True

    def test_dispatch_postal_code_de(self):
        """Dispatch to German postal code validator."""
        is_valid, msg = pdf_validators.validate_by_type("postal_code_de", "80802")
        assert is_valid is True

    def test_dispatch_integer_choice(self):
        """Dispatch to integer choice validator with config."""
        is_valid, msg = pdf_validators.validate_by_type(
