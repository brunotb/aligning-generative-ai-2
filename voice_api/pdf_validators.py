"""
Validators for Anmeldung form fields.

These validators are copied from api/pdf_filler.py to keep voice_api independent.
They validate field values according to German registration form requirements.
"""
...
def validate_by_type(
    ...
    if validator_type == "text":
        ...
        # Unknown validator type; pass through as valid
        return True, ""
